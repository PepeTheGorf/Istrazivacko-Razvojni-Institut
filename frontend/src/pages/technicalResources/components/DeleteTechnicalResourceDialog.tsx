...
interface DeleteTechnicalResourceDialogProps {
...
export function DeleteTechnicalResourceDialog({
  resource,
  deleting,
  onCancel,
  onConfirm,
}: DeleteTechnicalResourceDialogProps) {
  return (
    <div className="fixed inset-0 z-40 grid place-items-center bg-black/60 p-4">
      <div className="w-full max-w-lg rounded-lg border border-hairline bg-surface-1 p-6">
        ...
        <p className="mt-3 mb-6 text-sm text-ink-muted">
          Da li ste sigurni da želite da obrišete resurs <strong>{resource.name}</strong>?
        </p>
